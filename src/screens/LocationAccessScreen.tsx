...
export default function LocationAccessScreen() {
  ...
  const navigateNext = async (route: "HomeDrawer" | "ComingSoon") => {
    ...
    try {
      ...
      if (token) {
        try {
          // ✅ Check profile completeness via backend
          const profileStatus = await getCustomerProfileCompleteness();
          
          const hasFullProfile = profileStatus.profile_exists && profileStatus.profile_complete;
          ...
          // Token might be invalid, proceed as guest
  ...
  // =========================================================
  // ✅ CHECK AND REQUEST LOCATION (No changes needed)
  // =========================================================
